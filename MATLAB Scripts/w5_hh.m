...
% Try different stimulus values (amplitude)
stim_amp = 1;
...
% Try different stimulus values (amplitude) and duration
%{
stimdur  = 3 ;
stim_amp = 4 ;
...
stim_start_1 = stimdelay ;
stim_end_1   = stimdelay + stimdur ;

stim_start_2 = stimdelay ;
stim_end_2   = stimdelay + stimdur ;

simints = 3 ;

intervals_1(1,:) = [0,stim_start_1] ;
intervals_1(2,:) = [stim_start_1, stim_end_1] ;
intervals_1(3,:) = [stim_end_1, tend] ;

intervals_2(5,:) = [0,stim_start_2] ;
intervals_2(6,:) = [stim_start_2, stim_end_2] ;
intervals_2(7,:) = [stim_end_2, tend] ;
